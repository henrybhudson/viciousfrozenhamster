...
We weren't sure how to hide the API Key for OpenAI. Please let us know if you can't add transactions (this'll be due to the key). We stored it in a `.env` file and added that in the `.gitignore` file. (Table 21 in Orion, or at henry.b.hudson@durham.ac.uk or pawel.liskiewicz@durham.ac.uk).
